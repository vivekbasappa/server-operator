...
var reconcileErrorCounter = prometheus.NewCounter(prometheus.CounterOpts{
	Name: "app_reconcile_error_total",
...
var powerChangeAttempts = prometheus.NewCounterVec(prometheus.CounterOpts{
	Name: "app_operation_power_change_total",
...
var credentialsMissing = prometheus.NewCounter(prometheus.CounterOpts{
	Name: "app_credentials_missing_total",
...
var credentialsInvalid = prometheus.NewCounter(prometheus.CounterOpts{
	Name: "app_credentials_invalid_total",
...
var unhandledCredentialsError = prometheus.NewCounter(prometheus.CounterOpts{
	Name: "app_credentials_unhandled_error_total",
...
var hostConfigDataError = prometheus.NewCounterVec(prometheus.CounterOpts{
	Name: "app_host_config_data_error_total",
...
var stateTime = map[appv1alpha1.ProvisioningState]*prometheus.HistogramVec{
	appv1alpha1.StateRegistering: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		Name: "app_operation_register_duration_seconds",
		Help: "Length of time per registration per host",
	}, []string{labelHostNamespace, labelHostName}),
	appv1alpha1.StateInspecting: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		Name:    "app_operation_inspect_duration_seconds",
...
var stateChanges = prometheus.NewCounterVec(prometheus.CounterOpts{
	Name: "app_provisioning_state_change_total",
...
var hostRegistrationRequired = prometheus.NewCounter(prometheus.CounterOpts{
	Name: "app_host_registration_required_total",
...
var deleteWithoutDeprov = prometheus.NewCounter(prometheus.CounterOpts{
	Name: "app_delete_without_deprovisioning_total",
...
func stateChangeMetricLabels(prevState, newState appv1alpha1.ProvisioningState) prometheus.Labels {
	return prometheus.Labels{
